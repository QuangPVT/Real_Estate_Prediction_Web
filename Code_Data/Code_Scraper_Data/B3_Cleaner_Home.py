...
input_folder = 'Raw_Data/HCM_T5'
# input_folder = 'Raw_Data/HaNoi_T5'

# Đường dẫn thư mục chứa các file CSV đã làm sạch
output_folder = 'Clean_Data/HCM_T5'
# output_folder = 'Clean_Data/HaNoi_T5'
...
for file_name in os.listdir(input_folder):
    if file_name.endswith(".csv"):
        ...
        output_file_name = 'raw-data-' + file_name
